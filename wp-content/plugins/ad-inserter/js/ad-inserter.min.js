...
"");e.load(ajaxurl+"?action=ai_ajax_backend&websites="+d+b+"&ai_check="+ai_nonce,function(c,f,g){a("#ai-loading").hide();"error"==f?(c="Error downloading website data: "+g.status+" "+g.statusText,e.html(c),debug&&console.log(c)):(Va(),"function"==typeof ai_reload_websites_function&&(ai_reload_websites_function(),ai_reload_websites_function=null))})}function Q(b){list_search_reload=!1;var d=encodeURIComponent(a("#ai-list-search").val()),e=+!a("#ai-load-all").hasClass("light-blue"),c=a("#list-rearrange-controls"),
f=c.hasClass("rearrange");c.removeClass("rearrange").hide();a("#ai-rearrange").removeClass("blue");c="";if(f){c=a("table#ai-list-table");var g=c.data("blocks");"undefined"==typeof g&&(g=[]);var n=[];c.find("tbody tr").each(function(r){n.push(a(this).data("block"))});c="&blocks-org="+JSON.stringify(g)+"&blocks-new="+JSON.stringify(n)}var q=a("#ai-list-data");g=parseInt(a("#ai-data").attr("safe-mode"))?"&safe-mode":"";b="undefined"==typeof b?"":"&"+b;a("#ai-loading").show();q.load(ajaxurl+"?action=ai_ajax_backend&list="+
d+"&all="+e+"&start="+start+"&end="+end+"&active="+active_tab+c+g+b+"&ai_check="+ai_nonce,function(r,t,v){a("#ai-loading").hide();"error"==t?(r="Error downloading list data: "+v.status+" "+v.statusText,q.html(r),debug&&console.log(r)):(za(),"function"==typeof ai_reload_list_function&&(ai_reload_list_function(),ai_reload_list_function=null),f&&Wa())})}function R(b){adsense_search_reload=!1;var d=encodeURIComponent(a("#adsense-list-search").val()),e=+!a("#adsense-load-all").parent().find(".checkbox-icon").hasClass("on"),
...
r=a("input#adsense-client-secret").val();c.text(ai_admin.loading);a("#ai-loading").show();a.get(ajaxurl+"?action=ai_ajax_backend&adsense-client-id="+btoa(q)+"&adsense-client-secret="+btoa(r)+"&ai_check="+ai_nonce,function(t){R(!1)}).fail(function(t,v,B){console.log("Error saving AdSense client IDs: "+t.status+" "+t.statusText)}).always(function(){a("#ai-loading").hide()})}),a(".authorize-adsense",c).click(function(){a("#adsense-list-controls").show();c.text(ai_admin.loading);authorization_code="";
ka(authorization_code)})):a("#adsense-authorization-code",c).length?(a("#adsense-list-controls").hide(),a("button.ai-top-button",c).button().show(),a(".authorize-adsense",c).click(function(){var q="";a("#adsense-list-controls").show();c.text(ai_admin.loading);a(this).hasClass("clear-adsense")&&(q="");a(this).hasClass("own-ids")&&(q="own-ids");ka(q)})):(a("#adsense-list-controls").show(),f=a("#adsense-data",c).data("publisher-id"),"undefined"==typeof f&&(f=""),a("label#google-adsense-button").attr("title",
...
a("label.adsense-preview-code").click(function(){var q=a(this).closest("tr").data("id"),r=a(this).closest("tr").data("name"),t=screen.height/2-410;q={action:"ai_ajax_backend",preview:"adsense",ai_check:ai_nonce,read_only:1,slot_id:btoa(q),name:r};open_popup_window_post(ajaxurl,"width=820,height=820,top="+t+",left=100,resizable=yes,scrollbars=yes,toolbar=no,location=no,directories=no,status=no,menubar=no","preview",q)}),a("label.adsense-get-code").click(function(){var q=a(this).closest("tr").data("id");
atob(a(this).closest("tr").data("name"));debug&&console.log("ADSENSE CODE: ",q);a("#ai-loading").show();a.get(ajaxurl+"?action=ai_ajax_backend&adsense-code="+q+"&ai_check="+ai_nonce,function(r){r=JSON.parse(r);var t=r["error-message"];""==t?(r=r.code,debug&&console.log(r),set_editor_text(active_tab,r),setTimeout(function(){a("#import-code-"+active_tab).click()},10)):console.log("AdSense API error:",t)}).fail(function(r,t,v){console.log("Error downloading AdSense code: "+r.status+" "+r.statusText)}).always(function(){a("#ai-loading").hide()})}),
c.disableSelection())})}function O(){ads_txt_reload=!1;var b=a("#ads-txt-editor"),d=a("#ads-txt-reload"),e=a("#ads-txt-virtual").hasClass("violet")?"1":"0",c=b.hasClass("editor")?"text":"table",f=encodeURIComponent(a("#ads-txt-search").val()),g=a("#ads-txt-data");d.addClass("red");g.load(ajaxurl+"?action=ai_ajax_backend&ads-txt="+c+"&virtual="+e+"&search="+f+"&ai_check="+ai_nonce,function(n,q,r){d.removeClass("red");if("error"==q)n="Error loading ads.txt file: "+r.status+" "+r.statusText,g.html(n),
...
delay:700,showURL:!1,showBody:" | ",fade:250})}a("#ads-txt-controls").show()}})}function Xa(b){var d=a("#ads-txt-data"),e=a("#ads-txt-editor"),c=a("#ads-txt-reload"),f=a("#ads-txt-virtual").hasClass("violet")?"1":"0";d={text:b64e(d.find("textarea#ads-txt-text").val())};a("#ads-txt-error").text("");e.removeClass("green");e.addClass("red");a.post(ajaxurl+"?action=ai_ajax_backend&ads-txt=save&virtual="+f+"&ai_check="+ai_nonce,d).done(function(g){}).fail(function(g,n,q){e.removeClass("red");e.addClass("green");
...
g,n){c.find(".ai-error-message-text").text(f.status+" "+f.statusText);c.show();console.log("AI CHECK PAGES: Error loading positions for",b+":",f.status,f.statusText)}).always(function(){if(e){a("#ai-loading").hide();a("#ai-loading-2").hide();d.find("span.ui-button-text").removeClass("on");for(var f=start;f<=end;f++)na(f)}})}function Aa(){var b=[];if(0!=ai_tab_setup_delay){0!=active_tab&&b.push(0);for(var d=end;d>=start;d--)d!=active_tab&&b.push(d)}tabs_to_configure=b.concat(tabs_to_configure);0!=
...
active_tab),ya())});a(".ai-plugin-tab").click(function(){active_tab_0=a("#ai-plugin-settings-tab-container").tabs("option","active");debug&&console.log("active_tab_0: "+active_tab_0);if(syntax_highlighting){var e=a(this).attr("id");e=e.replace("ai-","");"h"==e?(e=ace.edit("editor-h"),e.getSession().highlightLines(1E7)):"f"==e?(e=ace.edit("editor-f"),e.getSession().highlightLines(1E7)):"a"==e&&(e=ace.edit("editor-a"),e.getSession().highlightLines(1E7))}});a("#check-pages-button").button({}).show().click(function(){var e=
...
a("input[title], button[title],  label[title], h2[title], li[title], td[title], select[title], div[title], span[title]").tooltip({track:!0,delay:700,showURL:!1,showBody:" | ",fade:250});debug&&console.log("");debug&&console.log("READY END");debug&&(C=(new Date).getTime(),console.log("main time: "+((C-Da)/1E3).toFixed(3)));a("#ads-txt-virtual").click(function(){function b(){var f=a("#ads-txt-virtual");f.removeClass("violet");f.attr("title",f.attr("title-physical")).tooltip({track:!0,delay:700,showURL:!1,
showBody:" | ",fade:250});setTimeout(function(){O()},50)}var d=a("#ads-txt-editor").hasClass("editor")?"text":"table",e=a("#ads-txt-virtual");if(e.hasClass("violet")){e=ai_admin.switch_to_physical_ads_txt;var c=a("#ads-txt-data").find("textarea#ads-txt-text").val();0!=a("#ads-txt-missing").length||"table"!=d&&""==c?b():a("<div />").html(e).attr("title",ai_admin.warning).dialog({bgiframe:!0,draggable:!1,resizable:!1,modal:!0,height:"auto",width:400,position:{my:"center",at:"center",of:"#ads-txt-container"},
buttons:[{text:ai_admin.switch,click:function(){a(this).dialog("close");b()}},{text:ai_admin.cancel,click:function(){a(this).dialog("close")}}]})}else e.addClass("violet"),e.attr("title",e.attr("title-virtual")).tooltip({track:!0,delay:700,showURL:!1,showBody:" | ",fade:250}),setTimeout(function(){O()},50)});a("#ads-txt-reload").click(function(){var b=a("#ads-txt-editor");b.hasClass("editor")&&b.removeClass("editor");setTimeout(function(){O()},50)});a("#ads-txt-editor").click(function(){a(this).hasClass("editor")?
setTimeout(function(){Xa(!0)},50):(a(this).addClass("editor"),setTimeout(function(){O()},50),a(this).attr("title",a(this).attr("title-table")).tooltip({track:!0,delay:700,showURL:!1,showBody:" | ",fade:250}))});a("#ads-txt-search").keyup(function(b){ads_txt_reload||(ads_txt_reload=!0,setTimeout(function(){O()},200))});a(".ai-public-controls").dblclick(function(){a(this).toggleClass("on")});a(".public-report-button").click(function(){var b=JSON.parse(a(this).attr("report-data")),d=b[0],e=b[1],c=a(this).parent().parent().parent().parent().find(".ai-public-controls").hasClass("on")?
"1":"0",f=a(this).parent().parent().parent().parent().find(".custom-range-controls").attr("range-name"),g=b[2];b=b[3];""==b&&(b="---");e=e+c+g+f+b;c=b64e(e).replaceAll("+",".").replaceAll("/","_").replaceAll("=","-");d=d+md5(e).substring(0,2)+c;window.open(d,"ai-report")});a("#ai-list-data").hasClass("ai-sticky")&&za();a("#ai-cancel-websites").click(function(){a("#ai-cancel-websites").hide();a("#ai-save-websites").hide();a("#ai-rearrange-websites").removeClass("blue");K()});a("#ai-add-website").click(function(){a("#ai-cancel-websites").hide();
a("#ai-save-websites").hide();a("#ai-rearrange-websites").removeClass("blue");ai_reload_websites_function=function(){a("#ai-website-list-table tr.ai-website-list").last().find(".ai-website-labels.ai-website-desc").click()};K("&add=")});a("#ai-save-websites").click(function(){var b=a(this).attr("data-connect");"undefined"!==typeof b&&!1!==b?(a(this).removeAttr("data-connect"),b="&connect="+b):b="";a("#ai-website-list-table tr.ai-website-list").each(function(){var e=a(this);e.find(".ai-website-editor .ai-website-key").is(":visible")&&
(e.find(".ai-website-editor .ai-website-key").attr("data-key",e.find(".ai-website-editor .ai-website-key").val()),e.find(".ai-website-labels.ai-website-desc").text(e.find(".ai-website-editor .ai-website-desc").val()),e.find(".ai-website-labels.ai-website-url").text(e.find(".ai-website-editor .ai-website-url").val()),e.find(".ai-website-labels").show(),e.find(".ai-website-editor").hide())});var d=[];a("#ai-website-list-table tr.ai-website-list").each(function(){var e=a(this),c=e.find(".ai-website-labels.ai-website-url").text().trim(),
f=e.find(".ai-website-labels.ai-website-desc").text().trim();e=e.find(".ai-website-editor .ai-website-key").attr("data-key").trim();""!=c&&d.push({url:c,name:f,key:b64e(e)})});a("#ai-cancel-websites").hide();a("#ai-save-websites").hide();a("#ai-rearrange-websites").removeClass("blue");K("&save="+b64e(JSON.stringify(d))+b)});a("#ai-rearrange-websites").click(function(){a(this).toggleClass("blue");var b=a("#ai-website-data");a(this).hasClass("blue")?(a("#ai-website-list-table .ai-delete-website").each(function(){a(this).closest("tr.ai-website-list").find(".ai-connect-website .checkbox-icon").hasClass("on")||
