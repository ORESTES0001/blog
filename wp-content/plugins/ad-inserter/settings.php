...
function generate_settings_form (){
  ...
  if (get_wait_for_jquery ()) {
    echo '<div class="notice notice-info is-dismissible" style="margin: 5px 15px 2px 0px;"><p>', __('Information', 'ad-inserter'), ': ', __('Legacy JavaScript code used', 'ad-inserter'), ', ', __('disable ', 'ad-inserter'), '<a class="simple-link" href="https://adinserter.pro/documentation/plugin-settings#wait-for-jquery" target="_blank">', __ ('Wait for jQuery', 'ad-inserter'), '</a></p></div>';
  }
